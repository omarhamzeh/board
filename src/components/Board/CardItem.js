        ...
        <Card.Body>
          ...
          <Card.Title>
            ...
            <div className="card-task-option pull-right">
              <a onClick={() => clickHandler("edit")}><i className="fas fa-edit"></i></a>
              &nbsp;
              <a onClick={() => clickHandler("delete")}><i className="fas fa-trash"></i></a>
            </div>
          </Card.Title>
          ...
          <table>
            <tbody>
              ...
              <tr>
                <td>{(props.task.description)}<br /><br /></td>
              </tr>
              ...
              <tr>
                <td>{formateDate(props.task.startDate)}<br /><br /></td>
              </tr>
              ...
              <tr>
                <td className="pull-right">{formateDate(props.task.endDate)}</td>
              </tr>

              <tr>
                <td align="center"><MDBCheckbox label="" id="checkboxExample" /></td>
              </tr>
            </tbody>
          </table>
        </Card.Body>
